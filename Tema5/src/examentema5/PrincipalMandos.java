...
public class PrincipalMandos {
	public static void main(String[] args) {
		...
		try {
			MandoDistancia m1 = new MandoTelevision("TG100", 2.5, 50);
			...
			//implementación comparator en base a los precios
			listaMandos.sort((a, b)->{return (int)(a.getPrecio()-b.getPrecio());});
